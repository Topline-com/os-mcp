...
const STATIC_ENTRIES: CatalogEntry[] = [
  ...
  { name: "ad_publishing_google", category: "Marketing", description: "Google Ads: integration, ad accounts, campaigns, audiences, conversions, targeting search, reporting. Exposed via topline_google_* umbrella tools.", status: "exposed", endpoint: "/ad-publishing/google/", notes: "Live PIT smoke test pending — exposing tools optimistically." },
  { name: "ad_publishing_linkedin", category: "Marketing", description: "LinkedIn Ads: integration, ad accounts, campaign groups, lead forms, targeting search, reporting. Exposed via topline_linkedin_* umbrella tools.", status: "exposed", endpoint: "/ad-publishing/linkedin/", notes: "Live PIT smoke test pending — exposing tools optimistically." },
