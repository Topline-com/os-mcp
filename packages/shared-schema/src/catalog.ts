...
const STATIC_ENTRIES: CatalogEntry[] = [
  ...
  { name: "ad_publishing_google", category: "Marketing", description: "Google Ads: integration, ad accounts, campaigns, audiences, conversions, targeting search, reporting. Tools exist (topline_google_* umbrella) but require additional scope beyond PIT 'Select All'.", status: "requires_oauth", endpoint: "/ad-publishing/google/", notes: "Probed 2026-05-23: GET /ad-publishing/google/integration returned 401 'token invalid' under a Select-All PIT that worked for /ad-publishing/facebook/integration. The Google ad-publishing scope isn't part of PIT Select-All — needs a marketplace OAuth app or a future scope expansion." },
  { name: "ad_publishing_linkedin", category: "Marketing", description: "LinkedIn Ads: integration, ad accounts, campaign groups, lead forms, targeting search, reporting. Tools exist (topline_linkedin_* umbrella) but require additional scope beyond PIT 'Select All'.", status: "requires_oauth", endpoint: "/ad-publishing/linkedin/", notes: "Probed 2026-05-23: GET /ad-publishing/linkedin/integration returned 401 under Select-All PIT. Same diagnosis as ad_publishing_google — needs marketplace OAuth." },
